...
namespace WurmAssistant
{
    ...
    /// <summary>
    /// Needs hooking up to threadsafe logger!
    /// </summary>
    public class SQLiteDB
    {
        ...
        /// <param name="alwaysConnected">If handler should maintain single connection open</param>
        ...
        {
            //Logger.WriteLine("Transaction error");
            if (_e != null) Logger.LogException(_e);
            ...
            {
                //Logger.WriteLine("Error while rolling back transaction " + Connection.ConnectionString);
                //Logger.DisplayExceptionData(_e2);
            }
            finally
            {
                Disconnect();
